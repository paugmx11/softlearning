...
static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Error creating sample book: " + e.getMessage());
        }
        ...
        System.out.println("\n *****   Add a new Client  ***** \n");
        try {
            clientRepo.save(Client.getInstance(
                "John Doe",
                999,
                "1990-01-15",
                "123 Main St",
            ...
            System.out.println("Error creating sample client: " + e.getMessage());
        }
