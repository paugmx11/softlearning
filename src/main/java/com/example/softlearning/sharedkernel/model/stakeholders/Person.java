...
import jakarta.persistence.Id; // Importante para las anotaciones
import jakarta.persistence.MappedSuperclass;
import jakarta.persistence.Transient;

@MappedSuperclass // Esta anotación permite que Client herede los campos y los mapee a su tabla
public abstract class Person {
    ...
    @Id // Define la clave primaria para Client y cualquier otra subclase
