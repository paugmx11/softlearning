...
import jakarta.persistence.Column; // Importante para JPA
...
public class Book {
    ...
    @Column(length = 1000) // Reservamos más espacio para la descripción si es necesario
    ...
    // JPA requiere un constructor público o protegido sin argumentos
    public Book() {
    }
